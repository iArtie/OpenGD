...
{
	switch (lid) {
	case 1: return "StereoMadness.mp3";
	case 2: return "BackOnTrack.mp3";
	case 3: return "Polargeist.mp3";
	case 4: return "DryOut.mp3";
	case 5: return "BaseAfterBase.mp3";
	case 6: return "CantLetGo.mp3";
	case 7: return "Jumper.mp3";
	case 8: return "TimeMachine.mp3";
	case 9: return "Cycles.mp3";
	case 10: return "xStep.mp3";
	case 11: return "Clutterfunk.mp3";
	case 12: return "TheoryOfEverything.mp3";
	case 13: return "Electroman.mp3";
	case 14: return "Clubstep.mp3";
	...
	case 19: return "GeometricalDominator.mp3";
	case 20: return "Deadlocked.mp3";
	case 21: return "Fingerdash.mp3";
...
std::string LevelTools::getAudioTitle(int lid) {
	...
	case 19: return "Geometrical Dominator";
	case 20: return "Deadlocked";
	case 21: return "Fingerdash";
